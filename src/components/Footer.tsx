...
const Footer = () => (
  <footer className="bg-foreground pt-8 pb-5">
    <div className="container mx-auto px-4 sm:px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <p className="font-body text-sm font-light text-primary-foreground/60 leading-relaxed mb-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 font-body text-sm text-primary-foreground/50 hover:text-gold transition-colors"
          >
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <p className="font-body text-xs uppercase tracking-widest text-primary-foreground/40 mb-4">Navigation</p>
            <ul className="space-y-2">
              {[
                ...
                <li key={l.href}>
                  <a href={l.href} className="font-body text-sm font-light text-primary-foreground/60 hover:text-gold transition-colors">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <p className="font-body text-xs uppercase tracking-widest text-primary-foreground/40 mb-4">Contact</p>
            <p className="font-body text-sm font-light text-primary-foreground/60 leading-relaxed">
      ...
      <div className="border-t border-primary-foreground/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <a
          ...
          className="font-body text-xs font-light text-primary-foreground/40 hover:text-gold transition-colors"
        >
