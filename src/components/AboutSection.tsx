...
const AboutSection = () => (
  <section id="apropos" className="py-12 md:py-24 lg:py-32 bg-section-alt">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center max-w-6xl mx-auto">
        <Reveal>
          <div className="overflow-hidden">
            <img
              ...
              className="w-full h-[280px] sm:h-[380px] md:h-[500px] object-cover hover:scale-105 transition-transform duration-700"
              loading="lazy"
              width={800}
              height={1000}
            />
        ...
        <Reveal delay={0.2}>
          <div>
            ...
            <h2 className="font-display text-5xl md:text-6xl font-semibold text-foreground mb-6 md:mb-8">
              À propos de <em className="italic">Douce Beauté</em>
            </h2>
            <p className="font-body text-base text-muted-foreground leading-relaxed mb-5 md:mb-6">
            ...
            <ul className="space-y-3 mb-6 md:mb-8">
              {promises.map((p) => (
                <li key={p.text} className="flex items-center gap-3">
                  <p.icon size={16} className="text-gold shrink-0" strokeWidth={1.8} />
                  <span className="font-body text-base text-muted-foreground">{p.text}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="flex gap-8 md:gap-12">
              ...
              <div>
                <p className="font-display text-3xl font-semibold text-gold">3 500+</p>
